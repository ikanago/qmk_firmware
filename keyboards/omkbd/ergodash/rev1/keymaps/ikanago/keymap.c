...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    _______, _______, KC_LALT, KC_LGUI,          LOWER,   KC_ENT , KC_BSPC,     _______, KC_SPC,  RAISE,            KC_RALT, _______, _______, _______  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,                        _______, KC_GRV,  KC_MINS, _______, KC_LBRC, KC_RBRC, KC_DQUO, \
  ...
  [_RAISE] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, _______, _______, \
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   _______,                        KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, \
    _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_MNXT, _______,                        _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ESC,  _______, \
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, KC_LNG2, KC_LNG1, _______, _______, _______, \
    _______, _______, _______, _______,          LOWER,   _______, _______,      _______, _______, RAISE,            _______, _______, _______, _______  \
  ),
