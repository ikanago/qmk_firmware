...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | Mouse|                    | Space|   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    MOUSE  ,                        KC_SPC , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
   ...
   * |      |       |KC_MS_U|       |       |       |      |                    |      |      |       |       |      |      |      |
   * |------+-------+-------+-------+-------+-------+---------------------------+------+------+-------+-------+------+------+------|
   * |      |KC_MS_L|KC_MS_D|KC_MS_R|KC_BTN1|KC_BTN2|      |                    |      |      |KC_WH_D|KC_WH_U|      |      |      |
   * |------+-------+-------+-------+-------+-------+---------------------------+------+------+-------+-------+------+------+------|
   * |      |       |       |       |       |       |      |                    |      |      |       |       |      |      |      |
   * |--------------+-------+-------+-------+-------+------+------+------+------+------+------+-------+-------+------+-------------|
   * |      |       |       |       |||||||||       |      |      ||||||||      |      |      |||||||||       |      |      |      |
  ...
  [_MOUSE] = LAYOUT(
    ...
    _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN1, KC_BTN2,_______,                       _______, _______, KC_WH_D, KC_WH_U, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______,_______,                       _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______,          _______,_______,_______,       _______,_______, _______,          _______, _______, _______, _______  \
  ),
