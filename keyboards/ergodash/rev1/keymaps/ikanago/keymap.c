...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |      |                    | Space|   N  |   M  |   ,  |   .  |   /  |  =   |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Ctrl |  GUI |  ALt |  GUI |||||||| Lower| Bksp |  Del |||||||| Enter| Space| Raise|||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    _______, _______, _______, KC_LGUI,          LOWER,   KC_SPC,  _______,      _______, KC_ENT , RAISE,            _______, _______, _______, _______  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,                        _______, KC_GRV,  KC_MINS, _______, KC_LBRC,  KC_RBRC, KC_PIPE, \
    _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,                        _______, KC_TILD, KC_UNDS, _______, KC_LCBR,  KC_RCBR, KC_BSLS, \
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |      | Mute |VolDn |VolUp |PlyPau|NextTr|      |                    |      | Left |  Up  | Down |Right | Esc  |      |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |                    |      |      |      |      |      |      |      |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |      |      |||||||| Lower|      |      ||||||||      |      | Raise||||||||      |      |      |      |
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, KC_MNXT, _______,                        _______, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, KC_ESC , _______, \
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______,          LOWER,   _______, _______,      _______, _______, RAISE,            _______, _______, _______, _______  \
  ),
